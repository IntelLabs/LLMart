...
The example in this folder shows how to implement the EoT originally introduced in [Athalye et al., 2018](https://proceedings.mlr.press/v80/athalye18b/athalye18b.pdf) for robust physical adversarial attack synthesis.
